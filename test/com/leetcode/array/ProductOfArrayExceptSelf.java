 ...
 * equal to the product of all the elements of nums except nums[i]. Solve it without division and in
 * O(n). For example, given [1,2,3,4], return [24,12,8,6]. Follow up: Could you solve it with
 ...
 * 
 * Numbers: 2 3 4 5 Lefts: 1 2 2*3 2*3*4 Rights: 3*4*5 4*5 5 1
 */
