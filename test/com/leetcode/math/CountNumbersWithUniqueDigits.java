...
public class CountNumbersWithUniqueDigits {
     ...
     * f(1) = 10. (0, 1, 2, 3, ...., 9)
     * 
     * f(2) = 9 * 9. Because for each number i from 1, ..., 9, we can pick j to form a 2-digit number ij and there are 9
     * numbers that are different from i for j to choose from.
     * 
